...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		ArrayList<Integer> DegreeSequence = new ArrayList<>(numOfVertices);
		
		for(int i = 0; i < numOfVertices; i++){
			int curVertexDegree = getNeighbors(i).size() + getInNeighbors(i).size();
			DegreeSequence.add(curVertexDegree);
		}
		DegreeSequence.sort((e1, e2) -> -e1.compareTo(e2));
